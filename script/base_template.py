...
while True:
    ...
    user_input = input("💡 \033[1;35mEnter GLBDM Number\n\033[0m(\033[1;36mtype \033[1;31mx\033[1;36m or \033[1;31mq\033[1;36m to cancel\033[0m)\n▸ ")
    print(f'\n💡 You have entered:  \033[1;32m{ user_input} \033[0m\n')
